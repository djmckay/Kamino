...
public final class KaminoErrorMiddleware: Middleware, ServiceType {
    /// See `ServiceType`.
    public static func makeService(for worker: Container) throws -> KaminoErrorMiddleware {
    ...
    ///     - log: Log destination.
    public static func `default`(environment: Environment, log: Logger) -> KaminoErrorMiddleware {
